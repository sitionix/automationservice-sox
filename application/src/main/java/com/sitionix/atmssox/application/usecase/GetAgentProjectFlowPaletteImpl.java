...
public class GetAgentProjectFlowPaletteImpl implements GetAgentProjectFlowPalette {
    ...
    public AgentProjectFlowPalette execute(final UUID projectId) {
        ...
        sources.add(AgentProjectFlowPaletteSource.builder().sourceType(USER_SOURCE_TYPE).sourceId(null).sourceName(USER_SOURCE_TYPE).build());
        sources.addAll(projectAgents.stream()
                .map(projectAgent -> AgentProjectFlowPaletteSource.builder()
