...
class WorkspaceProjectionHttpClientTest {
    ...
    @Test
    void givenValidSiteId_whenGetSiteOverview_thenReturnMappedJsonNode() {
        //given
        ...
        //when
        final JsonNode actual = this.workspaceProjectionHttpClient.getSiteOverview(givenSiteId);
    ...
    @Test
    void givenWorkspaceSitesResponse_whenGetWorkspaceSites_thenReturnMappedJsonNode() {
        //given
