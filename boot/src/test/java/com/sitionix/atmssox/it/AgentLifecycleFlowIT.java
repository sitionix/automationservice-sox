...
class AgentLifecycleFlowIT {
    ...
    @Test
    @DisplayName("Should return conflict and keep draft when archiving draft agent")
    void givenDraftAgent_whenArchive_thenReturnConflictAndKeepDraftInDb() {
        //given
        this.testManager.mockMvc()
                .ping(ControllerEndpoint.createAgent())
                .assertDefault();
        ...
        this.testManager.mockMvc()
                ...
                .andExpectPath(MockMvcResultMatchers.jsonPath("$.details").value("Invalid agent transition: DRAFT -> ARCHIVED"))
                .assertDefault();
