...
class AgentApiMapperTest {
    ...
    void givenCreateAgentRuleRequestDto_whenAsCreateAgentRuleCommand_thenReturnCommand() {
        ...
        //when
        final CreateAgentRuleCommand actual = this.agentApiMapper.asCreateAgentRuleCommand(given);
    ...
    void givenPatchAgentRuleRequestDto_whenAsPatchAgentRuleCommand_thenReturnCommand() {
        ...
        //when
        final PatchAgentRuleCommand actual = this.agentApiMapper.asPatchAgentRuleCommand(given);
    ...
    void givenAgentRule_whenAsAgentRuleDto_thenReturnRuleDto() {
        ...
        //when
        final AgentRuleDTO actual = this.agentApiMapper.asAgentRuleDto(given);
    ...
    void givenAgentRules_whenAsAgentRulesResponseDto_thenReturnWrappedItems() {
        ...
        //when
        final AgentRulesResponseDTO actual = this.agentApiMapper.asAgentRulesResponseDto(given);
    ...
    void givenDeleteAgentRuleResponse_whenAsDeleteAgentRuleResponseDto_thenReturnDeletedStatus() {
        ...
        //when
        final DeleteAgentRuleResponseDTO actual = this.agentApiMapper.asDeleteAgentRuleResponseDto(given);
